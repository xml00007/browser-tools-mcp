    ...
    <div>
        ...
        <div class="settings-section">
            ...
            <div class="checkbox-group-2" style="margin-top: 10px; display: flex; align-items: center;">
                <label>
                    <input type="checkbox" v-model="allowAutoPaste">
        ...
        <div class="settings-section">
            ...
            <div class="form-group">
                <label for="screenshot-path">Provide a directory to save screenshots to (by default screenshots will be
                    saved to your downloads folder if no path is provided)</label>
                <input type="text" id="screenshot-path" v-model="screenshotPath"
        ...
        <div class="settings-section">
            <div class="settings-header" @click="toggleAdvancedSettings">
                ...
                <svg :class="['chevron', { 'open': advancedSettingsVisible }]" viewBox="0 0 24 24" fill="none"
            ...
            <div :class="['settings-content', { 'visible': advancedSettingsVisible }]">
                <div class="form-group">
                    ...
                    <input type="number" id="log-limit" v-model="logLimit" min="1">
                </div>

                <div class="form-group">
                    <label for="query-limit">Query Limit (characters)</label>
                    <input type="number" id="query-limit" v-model="queryLimit" min="1">
                </div>

                <div class="form-group">
                    <label for="string-size-limit">String Size Limit (characters)</label>
                    <input type="number" id="string-size-limit" v-model="stringSizeLimit" min="1">
                </div>

                <div class="form-group">
                    <label for="max-log-size">Max Log Size (characters)</label>
                    <input type="number" id="max-log-size" v-model="maxLogSize" min="1000">
                </div>

                <div class="checkbox-group">
                    <label>
                        <input type="checkbox" v-model="showRequestHeaders">
                ...
                <div class="checkbox-group">
                    <label>
                        <input type="checkbox" v-model="showResponseHeaders">
