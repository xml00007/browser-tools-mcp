    ...
    <div class="panel-container">
        ...
        <div class="settings-section">
            ...
            <div class="form-group">
                ...
                <input type="text" id="screenshot-path" v-model="settings.screenshotPath"
        ...
        <div class="settings-section">
            ...
            <div :class="['settings-content', { 'visible': advancedSettingsVisible }]">
                <div class="form-group">
                    ...
                    <input type="number" id="log-limit" v-model="settings.logLimit" min="1">
                </div>

                <div class="form-group">
                    <label for="query-limit">Query Limit (characters)</label>
                    <input type="number" id="query-limit" v-model="settings.queryLimit" min="1">
                </div>

                <div class="form-group">
                    <label for="string-size-limit">String Size Limit (characters)</label>
                    <input type="number" id="string-size-limit" v-model="settings.stringSizeLimit" min="1">
                </div>

                <div class="form-group">
                    <label for="max-log-size">Max Log Size (characters)</label>
                    <input type="number" id="max-log-size" v-model="settings.maxLogSize" min="1000">
                </div>
...
const settings = reactive({
    ...
    serverPort: 3025, // Changed back to 3025 to avoid conflict with WXT dev server
    allowAutoPaste: true
})
