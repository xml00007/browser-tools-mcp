export default defineBackground(() => {
  ...
  async function updateServerWithUrl(tabId: number, url: string, source = "background_update") {
    if (!url) {
  ...
  function captureAndSendScreenshot(message: any, settings: any, sendResponse: (response: any) => void) {
